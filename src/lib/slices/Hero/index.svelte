...
<!-- <section data-slice-type={slice.slice_type} data-slice-variation={slice.variation} class="px-4 md:px-6">
	<div class="mx-auto w-full">
		<div class="min-h-[65vh] items-center">
			<div 
			class="relative z-10 -my-10 aspect-[1/1.3] overflow-hidden 
			md:mt-0 text-center"
			>
					<h1 
					class="mb-2 md:mb-2 text-[clamp(3rem,13vmin,13rem)] font-extrabold leading-none 
					tracking-tighter text-nowrap flex items-center justify-center"
					...
					<span 
					class="job-title block bg-gradient-to-tr from-blue-800 via-purple-600 to-blue-900 
					bg-clip-text text-transparent text-2xl font-bold lowercase tracing-[.2em] md:text-4xl opacity-0
...
<section data-slice-type={slice.slice_type} data-slice-variation={slice.variation} class="px-4 md:px-6">
	<div class="mx-auto w-full max-w-7xl">
		<div class="grid min-h-[65vh] grid-cols-1 items-center md:grid-cols-2">
			<div 
			class="relative z-10 row-span-1 row-start-1 -my-10 aspect-[1/1.3] overflow-hidden 
			md:col-space-1 md:col-start-2 md:mt-0"
			>
			<Scene />
