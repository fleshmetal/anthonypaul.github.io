...
<footer class="text-slate-600">
    <div class="container mx-auto flex mt-20 flex-col items-center justify-between gap-6 py-9 sm:flex-row">
        <div
        ...
        <nav class="navigation" aria-label="Footer Navigation">
            <ul class="flex items-center gap-1">
                ...
                <li>
                    <PrismicLink field={link} class="block px-3 py-1 text-base font-bold 
                    text-slate-100 transition-colors duration-150 hover:text-yellow-400"> {label} </PrismicLink>    
                </li>
        ...
        <div class="socials inline-flex justify-center sm:justify-end">
            ...
            <PrismicLink field={settings.data.github_link} class="p-2 text-2xl text-slate-300 transform transition-all duration-150 
            ...
            <PrismicLink field={settings.data.twitter_link} class="p-2 text-2xl text-slate-300 transform transition-all duration-150 
            hover:scale-125 hover:text-yellow-400"
            ...
            <PrismicLink field={settings.data.linkedin_link} class="p-2 text-2xl text-slate-300 transform transition-all duration-150 
            hover:scale-125 hover:text-yellow-400"
