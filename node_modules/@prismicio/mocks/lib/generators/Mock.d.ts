...
export interface WidgetMockWithDiff<D extends DynamicWidget, W extends WidgetContent, C extends MockConfig<Exclude<FieldType, DynamicSlices["type"]> | "Repeatable", unknown> | undefined = undefined> {
    generate(def: D, config?: C): W;
    patch(diff: DiffChange<unknown, unknown>, content?: W, config?: C): W | undefined;
}
export interface NestableMock<D extends DynamicWidget, W extends WidgetContent, C extends MockConfig<Exclude<FieldType, DynamicSlices["type"]> | "Repeatable", unknown> | undefined = undefined> extends WidgetMockWithDiff<D, W, C> {
    generate(def: D, config?: C): W;
    patch(diff: DiffChange<unknown, unknown>, content?: W, config?: C): W | undefined;
 ...
 */
export interface WidgetMock<D extends DynamicWidget, W extends WidgetContent, C extends MockConfig<Exclude<FieldType, typeof DynamicSlices["type"]> | "Repeatable", unknown> | undefined = undefined> {
    generate(def: D, config?: C): W;
}
