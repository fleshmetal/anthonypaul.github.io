...
exports.LinkMock = {
    ...
    applyPatch(data) {
        ...
        if (data.diff.value.type !== "Link" || ((_a = data.diff.value.config) === null || _a === void 0 ? void 0 : _a.repeat))
            return;
        const result = this.patch(data.diff, (0, content_1.isLinkContent)(data.content) ? data.content : undefined, ((_b = data.config) === null || _b === void 0 ? void 0 : _b.type) === "Link" ? data.config : undefined);
        return { result };
    },
