...
export declare const isSliceMachineError: <TName extends SliceMachineErrorNames>(error: unknown, name?: TName) => error is TName extends string ? ShallowSliceMachineError<TName> : Error;
