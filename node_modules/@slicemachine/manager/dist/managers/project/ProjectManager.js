...
import { requireResolve } from "../../lib/requireResolve.js";
...
Error Message: ${error2.message}`);
  ...
  async locateSliceMachineUIDir() {
    ...
    const sliceMachinePackageJSONPath = requireResolve(`${SLICE_MACHINE_NPM_PACKAGE_NAME}/package.json`, path.join(projectRoot, "index.js"));
  ...
  async locateAdapterDir() {
    ...
    const adapterPackageJSONPath = requireResolve(`${adapterName}/package.json`, path.join(projectRoot, "index.js"));
