...
const requireResolve = require("../../lib/requireResolve.cjs");
...
Error Message: ${error2.message}`);
  ...
  async locateSliceMachineUIDir() {
    ...
    const sliceMachinePackageJSONPath = requireResolve.requireResolve(`${SLICE_MACHINE_NPM_PACKAGE_NAME.SLICE_MACHINE_NPM_PACKAGE_NAME}/package.json`, path__namespace.join(projectRoot, "index.js"));
  ...
  async locateAdapterDir() {
    ...
    const adapterPackageJSONPath = requireResolve.requireResolve(`${adapterName}/package.json`, path__namespace.join(projectRoot, "index.js"));
