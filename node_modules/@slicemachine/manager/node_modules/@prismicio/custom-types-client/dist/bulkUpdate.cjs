...
const createBulkUpdateTransaction = (...args) => new BulkUpdateTransaction(...args);
class BulkUpdateTransaction {
  constructor(initialOperations = []) {
    __publicField(this, "operations");
    this.operations = initialOperations instanceof BulkUpdateTransaction ? initialOperations.operations : initialOperations;
  }
...
exports.BulkUpdateOperationType = BulkUpdateOperationType;
exports.BulkUpdateTransaction = BulkUpdateTransaction;
exports.createBulkUpdateTransaction = createBulkUpdateTransaction;
//# sourceMappingURL=bulkUpdate.cjs.map
